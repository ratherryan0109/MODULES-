# Counting Sort — Mini Project

## Project Overview
Build a practical Python application that demonstrates counting sort.
...
class CountingSortProcessor:
    """Process and manage counting sort data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using counting sort algorithm."""
...
def main() -> None:
    ...
    processor = CountingSortProcessor("demo")
