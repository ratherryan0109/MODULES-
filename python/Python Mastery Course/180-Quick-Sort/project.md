# Quick Sort — Mini Project

## Project Overview
Build a practical Python application that demonstrates quick sort.
...
class QuickSortProcessor:
    """Process and manage quick sort data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using quicksort divide and conquer."""
...
def main() -> None:
    ...
    processor = QuickSortProcessor("demo")
