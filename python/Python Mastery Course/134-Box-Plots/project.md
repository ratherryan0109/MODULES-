# Box Plots — Mini Project

## Project Overview
Build a practical Python application that demonstrates box plots.
This project reinforces the following concepts:
- plt.boxplot() basic box
- Box components (median, Q1, Q3, whiskers)
- Outlier detection (fliers)
- Multiple box plots
- Notched box plots
- Customizing box colors/styles
...
class BoxPlotsProcessor:
    """Process and manage box plots data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using plt.boxplot() basic box."""
...
def main() -> None:
    ...
    processor = BoxPlotsProcessor("demo")
