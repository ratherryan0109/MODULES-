...
## Project Overview
Build a practical Python application that demonstrates data cleaning.
...
class DataCleaningProcessor:
    """Process and manage data cleaning data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using detecting missing data (isna(), isnull())."""
...
def main() -> None:
    ...
    processor = DataCleaningProcessor("demo")
