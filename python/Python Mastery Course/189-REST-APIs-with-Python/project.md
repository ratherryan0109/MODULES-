# REST APIs with Python — Mini Project

## Project Overview
Build a practical Python application that demonstrates rest apis with python.
...
class RESTAPIswithPythonProcessor:
    """Process and manage rest apis with python data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using rest api design principles."""
...
def main() -> None:
    ...
    processor = RESTAPIswithPythonProcessor("demo")
