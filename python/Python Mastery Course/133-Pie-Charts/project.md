...
class PieChartsProcessor:
    """Process and manage pie charts data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using plt.pie() basic pie chart."""
...
def main() -> None:
    ...
    processor = PieChartsProcessor("demo")
