# Train Test Split — Mini Project

## Project Overview
Build a practical Python application that demonstrates train test split.
...
class TrainTestSplitProcessor:
    """Process and manage train test split data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using train_test_split() function."""
...
def main() -> None:
    ...
    processor = TrainTestSplitProcessor("demo")
