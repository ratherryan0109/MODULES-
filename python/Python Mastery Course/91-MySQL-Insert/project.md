# MySQL Insert — Mini Project

## Project Overview
Build a practical Python application that demonstrates mysql insert.
...
class MySQLInsertProcessor:
    """Process and manage mysql insert data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using insert into statement."""
...
def main() -> None:
    ...
    processor = MySQLInsertProcessor("demo")
