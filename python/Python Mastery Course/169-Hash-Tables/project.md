# Hash Tables — Mini Project

## Project Overview
Build a practical Python application that demonstrates hash tables.
This project reinforces the following concepts:
- Hash table concept
- Hash function properties
- Collision resolution (chaining, probing)
- Python dict hash table internals
- Load factor and resizing
- set() as hash table
- Custom __hash__ and __eq__
- Hash table vs tree map
...
class HashTablesProcessor:
    """Process and manage hash tables data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using hash table concept."""
...
def main() -> None:
    ...
    processor = HashTablesProcessor("demo")
