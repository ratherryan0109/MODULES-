# Radix Sort — Mini Project

## Project Overview
Build a practical Python application that demonstrates radix sort.
...
class RadixSortProcessor:
    """Process and manage radix sort data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using radix sort algorithm."""
...
def main() -> None:
    ...
    processor = RadixSortProcessor("demo")
