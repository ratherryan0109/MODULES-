# Horizontal Bar Charts — Mini Project

## Project Overview
Build a practical Python application that demonstrates horizontal bar charts.
...
class HorizontalBarChartsProcessor:
    """Process and manage horizontal bar charts data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using plt.barh() horizontal bars."""
...
def main() -> None:
    ...
    processor = HorizontalBarChartsProcessor("demo")
