...
## Project Overview
Build a practical Python application that demonstrates bubble sort.
...
class BubbleSortProcessor:
    """Process and manage bubble sort data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using bubble sort algorithm."""
...
def main() -> None:
    ...
    processor = BubbleSortProcessor("demo")
