# Binary Search Trees — Mini Project

## Project Overview
Build a practical Python application that demonstrates binary search trees.
...
class BinarySearchTreesProcessor:
    """Process and manage binary search trees data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using bst property (left < root < right)."""
...
def main() -> None:
    ...
    processor = BinarySearchTreesProcessor("demo")
