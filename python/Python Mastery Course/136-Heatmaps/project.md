# Heatmaps — Mini Project

## Project Overview
Build a practical Python application that demonstrates heatmaps.
...
class HeatmapsProcessor:
    """Process and manage heatmaps data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using plt.imshow() for heatmaps."""
...
def main() -> None:
    ...
    processor = HeatmapsProcessor("demo")
