...
## Project Overview
Build a practical Python application that demonstrates decision trees.
This project reinforces the following concepts:
- Decision tree structure (nodes, leaves)
- Gini impurity and entropy
- Information gain for splits
- Max depth and pruning
...
class DecisionTreesProcessor:
    """Process and manage decision trees data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using decision tree structure (nodes, leaves)."""
...
def main() -> None:
    ...
    processor = DecisionTreesProcessor("demo")
