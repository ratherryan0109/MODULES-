# MySQL Create Table — Mini Project

## Project Overview
Build a practical Python application that demonstrates mysql create table.
This project reinforces the following concepts:
- CREATE TABLE statement
- Column data types (INT, VARCHAR, DATE)
- NOT NULL and DEFAULT constraints
- PRIMARY KEY specification
- AUTO_INCREMENT columns
- UNIQUE and CHECK constraints
- INDEXES for performance
- IF NOT EXISTS with tables
...
class MySQLCreateTableProcessor:
    """Process and manage mysql create table data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using create table statement."""
...
def main() -> None:
    ...
    processor = MySQLCreateTableProcessor("demo")
