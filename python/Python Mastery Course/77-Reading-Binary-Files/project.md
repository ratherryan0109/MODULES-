# Reading Binary Files — Mini Project

## Project Overview
Build a practical Python application that demonstrates reading binary files.
...
class ReadingBinaryFilesProcessor:
    """Process and manage reading binary files data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using read() on binary files (returns bytes)."""
...
def main() -> None:
    ...
    processor = ReadingBinaryFilesProcessor("demo")
