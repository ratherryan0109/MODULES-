# Class Properties — Mini Project

## Project Overview
Build a practical Python application that demonstrates class properties.
...
class ClassPropertiesProcessor:
    """Process and manage class properties data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using @property decorator (getter)."""
...
def main() -> None:
    ...
    processor = ClassPropertiesProcessor("demo")
