...
## Project Overview
Build a practical Python application that demonstrates merge sort.
This project reinforces the following concepts:
- Mergesort divide and conquer
- Recursive splitting to base case
- Merge operation (two sorted lists)
...
class MergeSortProcessor:
    """Process and manage merge sort data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using mergesort divide and conquer."""
...
def main() -> None:
    ...
    processor = MergeSortProcessor("demo")
