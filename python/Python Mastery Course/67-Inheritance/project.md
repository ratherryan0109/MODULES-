...
## Project Overview
Build a practical Python application that demonstrates inheritance.
...
class InheritanceProcessor:
    """Process and manage inheritance data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using single inheritance syntax."""
...
def main() -> None:
    ...
    processor = InheritanceProcessor("demo")
