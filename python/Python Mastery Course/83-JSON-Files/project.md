# JSON Files — Mini Project

## Project Overview
Build a practical Python application that demonstrates json files.
...
class JSONFilesProcessor:
    """Process and manage json files data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using json.load() reading from files."""
...
def main() -> None:
    ...
    processor = JSONFilesProcessor("demo")
