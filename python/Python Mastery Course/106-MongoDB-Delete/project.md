# MongoDB Delete — Mini Project

## Project Overview
Build a practical Python application that demonstrates mongodb delete.
...
class MongoDBDeleteProcessor:
    """Process and manage mongodb delete data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using delete_one() for single document."""
...
def main() -> None:
    ...
    processor = MongoDBDeleteProcessor("demo")
