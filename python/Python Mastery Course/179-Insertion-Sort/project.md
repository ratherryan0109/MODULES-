...
## Project Overview
Build a practical Python application that demonstrates insertion sort.
...
class InsertionSortProcessor:
    """Process and manage insertion sort data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using insertion sort algorithm."""
...
def main() -> None:
    ...
    processor = InsertionSortProcessor("demo")
