# Saving Charts — Mini Project

## Project Overview
Build a practical Python application that demonstrates saving charts.
...
class SavingChartsProcessor:
    """Process and manage saving charts data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using plt.savefig() function."""
...
def main() -> None:
    ...
    processor = SavingChartsProcessor("demo")
