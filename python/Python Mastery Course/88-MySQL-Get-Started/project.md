# MySQL Get Started — Mini Project

## Project Overview
Build a practical Python application that demonstrates mysql get started.
...
class MySQLGetStartedProcessor:
    """Process and manage mysql get started data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using mysql server installation."""
...
def main() -> None:
    ...
    processor = MySQLGetStartedProcessor("demo")
