# Percentile — Mini Project

## Project Overview
Build a practical Python application that demonstrates percentile.
...
class PercentileProcessor:
    """Process and manage percentile data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using percentile definition (pth percentile)."""
...
def main() -> None:
    ...
    processor = PercentileProcessor("demo")
