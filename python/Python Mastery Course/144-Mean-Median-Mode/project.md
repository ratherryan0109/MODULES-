# Mean Median Mode — Mini Project

## Project Overview
Build a practical Python application that demonstrates mean median mode.
This project reinforces the following concepts:
- Mean (average) calculation
- Median (middle value) calculation
- Mode (most frequent) calculation
- Mean vs median for skewed data
- Weighted mean
- Trimmed mean for outliers
- Mode for categorical data
- Central tendency in NumPy/SciPy
...
class MeanMedianModeProcessor:
    """Process and manage mean median mode data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using mean (average) calculation."""
...
def main() -> None:
    ...
    processor = MeanMedianModeProcessor("demo")
