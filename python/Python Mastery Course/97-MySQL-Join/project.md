# MySQL JOIN — Mini Project

## Project Overview
Build a practical Python application that demonstrates mysql join.
This project reinforces the following concepts:
- INNER JOIN for matching rows
- LEFT JOIN for all left rows
- RIGHT JOIN for all right rows
...
class MySQLJOINProcessor:
    """Process and manage mysql join data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using inner join for matching rows."""
...
def main() -> None:
    ...
    processor = MySQLJOINProcessor("demo")
