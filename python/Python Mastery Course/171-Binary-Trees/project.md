# Binary Trees — Mini Project

## Project Overview
Build a practical Python application that demonstrates binary trees.
This project reinforces the following concepts:
- Binary tree definition
- Full, complete, perfect binary trees
- Binary tree node class
- Recursive traversal (pre, in, post)
...
class BinaryTreesProcessor:
    """Process and manage binary trees data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using binary tree definition."""
...
def main() -> None:
    ...
    processor = BinaryTreesProcessor("demo")
