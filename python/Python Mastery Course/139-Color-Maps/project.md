# Color Maps — Mini Project

## Project Overview
Build a practical Python application that demonstrates color maps.
This project reinforces the following concepts:
- Colormap types (sequential, diverging, qualitative)
- Built-in colormaps (viridis, plasma, inferno)
- Custom colormap creation
- Colormap normalization
- Reversed colormaps (_r suffix)
- Colorbar ticks and labels
- Discrete color mapping (ListedColormap)
...
class ColorMapsProcessor:
    """Process and manage color maps data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using colormap types (sequential, diverging, qualitative)."""
...
def main() -> None:
    ...
    processor = ColorMapsProcessor("demo")
