# AUC ROC Curve — Mini Project

## Project Overview
Build a practical Python application that demonstrates auc roc curve.
...
class AUCROCCurveProcessor:
    """Process and manage auc roc curve data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using roc curve (tpr vs fpr)."""
...
def main() -> None:
    ...
    processor = AUCROCCurveProcessor("demo")
