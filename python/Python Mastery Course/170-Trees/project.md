...
## Project Overview
Build a practical Python application that demonstrates trees.
This project reinforces the following concepts:
- Tree terminology (root, leaf, parent, child)
- Tree node class
- Depth vs height
- Pre-order traversal
- In-order traversal
...
- Tree applications (file systems, HTML DOM)
...
class TreesProcessor:
    """Process and manage trees data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using tree terminology (root, leaf, parent, child)."""
