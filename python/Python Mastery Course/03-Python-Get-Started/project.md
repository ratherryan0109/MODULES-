# Python Get Started — Mini Project

## Project Overview
Build a practical Python application that demonstrates python get started.
...
class PythonGetStartedProcessor:
    """Process and manage python get started data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using hello world program."""
...
def main() -> None:
    ...
    processor = PythonGetStartedProcessor("demo")
