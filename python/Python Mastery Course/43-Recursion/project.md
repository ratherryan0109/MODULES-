...
## Project Overview
Build a practical Python application that demonstrates recursion.
...
class RecursionProcessor:
    """Process and manage recursion data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using recursive function pattern."""
...
def main() -> None:
    ...
    processor = RecursionProcessor("demo")
