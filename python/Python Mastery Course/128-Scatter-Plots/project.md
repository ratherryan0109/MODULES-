# Scatter Plots — Mini Project

## Project Overview
Build a practical Python application that demonstrates scatter plots.
...
class ScatterPlotsProcessor:
    """Process and manage scatter plots data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using plt.scatter(x, y)."""
...
def main() -> None:
    ...
    processor = ScatterPlotsProcessor("demo")
