...
## Project Overview
Build a practical Python application that demonstrates grid.
This project reinforces the following concepts:
- plt.grid() basic grid
- Grid on/off control
- Major vs minor grid lines
- Customizing grid style (linestyle, alpha)
- Grid on specific axis only
- Grid line color and width
- Axis-specific grid settings
- Grid z-order (behind data)
...
class GridProcessor:
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using plt.grid() basic grid."""
