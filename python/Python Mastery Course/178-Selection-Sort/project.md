...
## Project Overview
Build a practical Python application that demonstrates selection sort.
...
class SelectionSortProcessor:
    """Process and manage selection sort data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using selection sort algorithm."""
...
def main() -> None:
    ...
    processor = SelectionSortProcessor("demo")
