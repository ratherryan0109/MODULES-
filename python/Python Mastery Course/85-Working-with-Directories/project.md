# Working with Directories — Mini Project

## Project Overview
Build a practical Python application that demonstrates working with directories.
...
class WorkingwithDirectoriesProcessor:
    """Process and manage working with directories data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using os.listdir() and os.scandir()."""
...
def main() -> None:
    ...
    processor = WorkingwithDirectoriesProcessor("demo")
