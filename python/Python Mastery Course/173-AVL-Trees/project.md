# AVL Trees — Mini Project

## Project Overview
Build a practical Python application that demonstrates avl trees.
This project reinforces the following concepts:
- AVL tree balance concept
...
class AVLTreesProcessor:
    """Process and manage avl trees data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using avl tree balance concept."""
...
def main() -> None:
    ...
    processor = AVLTreesProcessor("demo")
