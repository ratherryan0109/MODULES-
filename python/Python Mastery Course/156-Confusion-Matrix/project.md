# Confusion Matrix — Mini Project

## Project Overview
Build a practical Python application that demonstrates confusion matrix.
...
class ConfusionMatrixProcessor:
    """Process and manage confusion matrix data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using confusion matrix structure."""
...
def main() -> None:
    ...
    processor = ConfusionMatrixProcessor("demo")
