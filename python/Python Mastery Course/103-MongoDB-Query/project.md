# MongoDB Query — Mini Project

## Project Overview
Build a practical Python application that demonstrates mongodb query.
...
class MongoDBQueryProcessor:
    """Process and manage mongodb query data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using comparison operators ($gt, $lt, $gte, $lte)."""
...
def main() -> None:
    ...
    processor = MongoDBQueryProcessor("demo")
