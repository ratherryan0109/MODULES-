# CSV Files — Mini Project

## Project Overview
Build a practical Python application that demonstrates csv files.
...
class CSVFilesProcessor:
    """Process and manage csv files data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using csv.reader() and csv.writer()."""
...
def main() -> None:
    ...
    processor = CSVFilesProcessor("demo")
