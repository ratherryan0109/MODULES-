# Encapsulation — Mini Project

## Project Overview
Build a practical Python application that demonstrates encapsulation.
...
class EncapsulationProcessor:
    """Process and manage encapsulation data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using single underscore convention (_)."""
...
def main() -> None:
    ...
    processor = EncapsulationProcessor("demo")
