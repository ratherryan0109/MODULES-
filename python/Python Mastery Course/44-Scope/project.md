...
## Project Overview
Build a practical Python application that demonstrates scope.
...
class ScopeProcessor:
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using legb rule (local, enclosing, global, built-in)."""
