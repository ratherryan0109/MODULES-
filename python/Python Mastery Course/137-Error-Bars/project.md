# Error Bars — Mini Project

## Project Overview
Build a practical Python application that demonstrates error bars.
...
class ErrorBarsProcessor:
    """Process and manage error bars data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using plt.errorbar(x, y, yerr, xerr)."""
...
def main() -> None:
    ...
    processor = ErrorBarsProcessor("demo")
