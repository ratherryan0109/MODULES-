# MySQL Select — Mini Project

## Project Overview
Build a practical Python application that demonstrates mysql select.
...
class MySQLSelectProcessor:
    """Process and manage mysql select data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using select statement basics."""
...
def main() -> None:
    ...
    processor = MySQLSelectProcessor("demo")
