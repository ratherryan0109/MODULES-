...
## Project Overview
Build a practical Python application that demonstrates regular expressions.
...
class RegularExpressionsProcessor:
    """Process and manage regular expressions data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using re.match() vs re.search() vs re.fullmatch()."""
...
def main() -> None:
    ...
    processor = RegularExpressionsProcessor("demo")
