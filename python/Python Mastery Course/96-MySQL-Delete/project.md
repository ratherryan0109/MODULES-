# MySQL Delete — Mini Project

## Project Overview
Build a practical Python application that demonstrates mysql delete.
...
class MySQLDeleteProcessor:
    """Process and manage mysql delete data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using delete statement syntax."""
...
def main() -> None:
    ...
    processor = MySQLDeleteProcessor("demo")
