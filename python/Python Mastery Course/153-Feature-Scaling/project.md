...
## Project Overview
Build a practical Python application that demonstrates feature scaling.
...
class FeatureScalingProcessor:
    """Process and manage feature scaling data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using standardscaler (z-score)."""
...
def main() -> None:
    ...
    processor = FeatureScalingProcessor("demo")
