# Normal Distribution — Mini Project

## Project Overview
Build a practical Python application that demonstrates normal distribution.
This project reinforces the following concepts:
- Normal distribution formula
- Mean and standard deviation parameters
- Standard normal distribution
- Central Limit Theorem
- np.random.normal() generation
- scipy.stats.norm for analysis
...
class NormalDistributionProcessor:
    """Process and manage normal distribution data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using normal distribution formula."""
...
def main() -> None:
    ...
    processor = NormalDistributionProcessor("demo")
