...
## Project Overview
Build a practical Python application that demonstrates stacks.
...
class StacksProcessor:
    """Process and manage stacks data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using stack lifo principle."""
...
def main() -> None:
    ...
    processor = StacksProcessor("demo")
