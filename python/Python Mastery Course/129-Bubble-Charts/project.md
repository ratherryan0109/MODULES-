# Bubble Charts — Mini Project

## Project Overview
Build a practical Python application that demonstrates bubble charts.
This project reinforces the following concepts:
- Bubble chart concept
- Size encoding (s parameter)
- Color encoding third variable
- Bubble transparency
- Bubble chart with legend
- Normalizing bubble sizes
- Scale axes for bubbles
...
class BubbleChartsProcessor:
    """Process and manage bubble charts data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using bubble chart concept."""
...
def main() -> None:
    ...
    processor = BubbleChartsProcessor("demo")
