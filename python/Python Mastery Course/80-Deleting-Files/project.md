# Deleting Files — Mini Project

## Project Overview
Build a practical Python application that demonstrates deleting files.
...
class DeletingFilesProcessor:
    """Process and manage deleting files data."""
    ...
    def process(self, data: List[int]) -> List[int]:
        """Process input data using os.remove() for files."""
...
def main() -> None:
    ...
    processor = DeletingFilesProcessor("demo")
