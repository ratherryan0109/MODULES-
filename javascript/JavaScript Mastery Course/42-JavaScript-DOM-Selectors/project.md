# JavaScript DOM Selectors - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript DOM Selectors.
...
- getElementById fast lookup
- Live HTMLCollection vs static NodeList
- Closest() method

## Learning Objectives
By completing this project, you will:
1. Apply css selectors with queryselector in a practical context
2. Implement javascript dom selectors following best practices
...
- Implement CSS selectors with querySelector and querySelectorAll static collection and getElementById fast lookup
...
```javascript
/**
 * JavaScriptDOMSelectors - JavaScript DOM Selectors
 * A practical implementation demonstrating javascript dom selectors
 */
class JavaScriptDOMSelectors {
  constructor(options = {}) {
...
const project = new JavaScriptDOMSelectors();
try {
  project.add("CSS selectors with querySelector");
  project.add("querySelectorAll static collection");
...
1. Implement the css selectors with queryselector functionality
2. Add querySelectorAll static collection capabilities
...
```
Processed: [
  { original: "CSS selectors with querySelector", processed: "CSS SELECTORS WITH QUERYSELECTOR", timestamp: ... },
  { original: "querySelectorAll static collection", processed: "QUERYSELECTORALL STATIC COLLECTION", timestamp: ... }
]
History: [
  { action: "add", item: "CSS selectors with querySelector", timestamp: ... },
  { action: "add", item: "querySelectorAll static collection", timestamp: ... }
]
```
