# JavaScript WebSockets - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript WebSockets.
...
- Room and namespace (Socket.IO)

## Learning Objectives
By completing this project, you will:
1. Apply websocket api in a practical context
2. Implement javascript websockets following best practices
...
- Implement WebSocket API and Socket.IO library and Message handling (send/receive)
...
```javascript
/**
 * JavaScriptWebSockets - JavaScript WebSockets
 * A practical implementation demonstrating javascript websockets
 */
class JavaScriptWebSockets {
  constructor(options = {}) {
...
const project = new JavaScriptWebSockets();
try {
  project.add("WebSocket API");
  project.add("Socket.IO library");
...
1. Implement the websocket api functionality
2. Add Socket.IO library capabilities
...
```
Processed: [
  { original: "WebSocket API", processed: "WEBSOCKET API", timestamp: ... },
  { original: "Socket.IO library", processed: "SOCKET.IO LIBRARY", timestamp: ... }
]
History: [
  { action: "add", item: "WebSocket API", timestamp: ... },
  { action: "add", item: "Socket.IO library", timestamp: ... }
]
```
