# JavaScript Keyboard and Mouse Events - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Keyboard and Mouse Events.
...
1. Apply keydown, keypress, keyup in a practical context
2. Implement javascript keyboard and mouse events following best practices
...
- Implement keydown, keypress, keyup and event.key vs event.code and Mouse events (click, dblclick, mousedown, mouseup)
...
```javascript
/**
 * JavaScriptKeyboardandMouseEvents - JavaScript Keyboard and Mouse Events
 * A practical implementation demonstrating javascript keyboard and mouse events
 */
class JavaScriptKeyboardandMouseEvents {
  constructor(options = {}) {
...
const project = new JavaScriptKeyboardandMouseEvents();
try {
  project.add("keydown, keypress, keyup");
  project.add("event.key vs event.code");
...
1. Implement the keydown, keypress, keyup functionality
2. Add event.key vs event.code capabilities
...
```
Processed: [
  { original: "keydown, keypress, keyup", processed: "KEYDOWN, KEYPRESS, KEYUP", timestamp: ... },
  { original: "event.key vs event.code", processed: "EVENT.KEY VS EVENT.CODE", timestamp: ... }
]
History: [
  { action: "add", item: "keydown, keypress, keyup", timestamp: ... },
  { action: "add", item: "event.key vs event.code", timestamp: ... }
]
```
