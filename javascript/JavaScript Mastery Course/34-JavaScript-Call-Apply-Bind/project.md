# JavaScript call, apply, bind - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript call, apply, bind.
...
1. Apply call() - function borrowing in a practical context
2. Implement javascript call, apply, bind following best practices
...
- Implement call() - function borrowing and apply() - array arguments and bind() - permanent binding
...
```javascript
/**
 * JavaScriptCallApplyBind - JavaScript call, apply, bind
 * A practical implementation demonstrating javascript call, apply, bind
 */
class JavaScriptCallApplyBind {
  constructor(options = {}) {
...
const project = new JavaScriptCallApplyBind();
try {
  project.add("call() - function borrowing");
  project.add("apply() - array arguments");
...
1. Implement the call() - function borrowing functionality
2. Add apply() - array arguments capabilities
...
```
Processed: [
  { original: "call() - function borrowing", processed: "CALL() - FUNCTION BORROWING", timestamp: ... },
  { original: "apply() - array arguments", processed: "APPLY() - ARRAY ARGUMENTS", timestamp: ... }
]
History: [
  { action: "add", item: "call() - function borrowing", timestamp: ... },
  { action: "add", item: "apply() - array arguments", timestamp: ... }
]
```
