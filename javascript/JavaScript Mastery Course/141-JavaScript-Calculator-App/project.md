# JavaScript Calculator App - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Calculator App.
This project will help you apply the following concepts in a real-world scenario:

- UI design for calculator
- Expression parsing
...
1. Apply ui design for calculator in a practical context
2. Implement javascript calculator app following best practices
...
- Implement UI design for calculator and Expression parsing and Keyboard event handling
...
```javascript
/**
 * JavaScriptCalculatorApp - JavaScript Calculator App
 * A practical implementation demonstrating javascript calculator app
 */
class JavaScriptCalculatorApp {
  constructor(options = {}) {
...
const project = new JavaScriptCalculatorApp();
try {
  project.add("UI design for calculator");
  project.add("Expression parsing");
...
1. Implement the ui design for calculator functionality
2. Add Expression parsing capabilities
...
```
Processed: [
  { original: "UI design for calculator", processed: "UI DESIGN FOR CALCULATOR", timestamp: ... },
  { original: "Expression parsing", processed: "EXPRESSION PARSING", timestamp: ... }
]
History: [
  { action: "add", item: "UI design for calculator", timestamp: ... },
  { action: "add", item: "Expression parsing", timestamp: ... }
]
```
