# JavaScript Searching Algorithms - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Searching Algorithms.
...
1. Apply linear search in a practical context
2. Implement javascript searching algorithms following best practices
...
- Implement Linear search and Binary search and Depth-first search (DFS)
...
```javascript
/**
 * JavaScriptSearchingAlgorithms - JavaScript Searching Algorithms
 * A practical implementation demonstrating javascript searching algorithms
 */
class JavaScriptSearchingAlgorithms {
  constructor(options = {}) {
...
const project = new JavaScriptSearchingAlgorithms();
try {
  project.add("Linear search");
  project.add("Binary search");
...
1. Implement the linear search functionality
2. Add Binary search capabilities
...
```
Processed: [
  { original: "Linear search", processed: "LINEAR SEARCH", timestamp: ... },
  { original: "Binary search", processed: "BINARY SEARCH", timestamp: ... }
]
History: [
  { action: "add", item: "Linear search", timestamp: ... },
  { action: "add", item: "Binary search", timestamp: ... }
]
```
