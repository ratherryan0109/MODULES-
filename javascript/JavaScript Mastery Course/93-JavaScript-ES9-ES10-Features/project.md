# JavaScript ES9/ES10 Features - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript ES9/ES10 Features.
...
1. Apply rest/spread for objects in a practical context
2. Implement javascript es9/es10 features following best practices
...
- Implement Rest/spread for objects and Async iteration (for await...of) and Promise.prototype.finally
...
```javascript
/**
 * JavaScriptES9ES10Features - JavaScript ES9/ES10 Features
 * A practical implementation demonstrating javascript es9/es10 features
 */
class JavaScriptES9ES10Features {
  constructor(options = {}) {
...
const project = new JavaScriptES9ES10Features();
try {
  project.add("Rest/spread for objects");
  project.add("Async iteration (for await...of)");
...
1. Implement the rest/spread for objects functionality
2. Add Async iteration (for await...of) capabilities
...
```
Processed: [
  { original: "Rest/spread for objects", processed: "REST/SPREAD FOR OBJECTS", timestamp: ... },
  { original: "Async iteration (for await...of)", processed: "ASYNC ITERATION (FOR AWAIT...OF)", timestamp: ... }
]
History: [
  { action: "add", item: "Rest/spread for objects", timestamp: ... },
  { action: "add", item: "Async iteration (for await...of)", timestamp: ... }
]
```
