# JavaScript Music Player - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Music Player.
...
1. Apply html5 audio api in a practical context
2. Implement javascript music player following best practices
...
- Implement HTML5 Audio API and Playlist management and Play, pause, skip controls
...
```javascript
/**
 * JavaScriptMusicPlayer - JavaScript Music Player
 * A practical implementation demonstrating javascript music player
 */
class JavaScriptMusicPlayer {
  constructor(options = {}) {
...
const project = new JavaScriptMusicPlayer();
try {
  project.add("HTML5 Audio API");
  project.add("Playlist management");
...
1. Implement the html5 audio api functionality
2. Add Playlist management capabilities
...
```
Processed: [
  { original: "HTML5 Audio API", processed: "HTML5 AUDIO API", timestamp: ... },
  { original: "Playlist management", processed: "PLAYLIST MANAGEMENT", timestamp: ... }
]
History: [
  { action: "add", item: "HTML5 Audio API", timestamp: ... },
  { action: "add", item: "Playlist management", timestamp: ... }
]
```
