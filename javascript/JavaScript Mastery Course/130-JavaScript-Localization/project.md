# JavaScript Localization - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Localization.
...
1. Apply locale detection in a practical context
2. Implement javascript localization following best practices
...
- Implement Locale detection and Translation strategies and Intl API localization
...
```javascript
/**
 * JavaScriptLocalization - JavaScript Localization
 * A practical implementation demonstrating javascript localization
 */
...
const project = new JavaScriptLocalization();
try {
  project.add("Locale detection");
  project.add("Translation strategies");
...
1. Implement the locale detection functionality
2. Add Translation strategies capabilities
...
```
Processed: [
  { original: "Locale detection", processed: "LOCALE DETECTION", timestamp: ... },
  { original: "Translation strategies", processed: "TRANSLATION STRATEGIES", timestamp: ... }
]
History: [
  { action: "add", item: "Locale detection", timestamp: ... },
  { action: "add", item: "Translation strategies", timestamp: ... }
]
```
