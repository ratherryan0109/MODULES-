# JavaScript Drag and Drop - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Drag and Drop.
...
1. Apply dragstart, dragover, drop events in a practical context
2. Implement javascript drag and drop following best practices
...
- Implement dragstart, dragover, drop events and DataTransfer API and Draggable attribute
...
```javascript
/**
 * JavaScriptDragandDrop - JavaScript Drag and Drop
 * A practical implementation demonstrating javascript drag and drop
 */
class JavaScriptDragandDrop {
  constructor(options = {}) {
...
const project = new JavaScriptDragandDrop();
try {
  project.add("dragstart, dragover, drop events");
  project.add("DataTransfer API");
...
1. Implement the dragstart, dragover, drop events functionality
2. Add DataTransfer API capabilities
...
```
Processed: [
  { original: "dragstart, dragover, drop events", processed: "DRAGSTART, DRAGOVER, DROP EVENTS", timestamp: ... },
  { original: "DataTransfer API", processed: "DATATRANSFER API", timestamp: ... }
]
History: [
  { action: "add", item: "dragstart, dragover, drop events", timestamp: ... },
  { action: "add", item: "DataTransfer API", timestamp: ... }
]
```
