# JavaScript Class Inheritance - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Class Inheritance.
...
1. Apply extends keyword in a practical context
2. Implement javascript class inheritance following best practices
...
- Implement extends keyword and super() constructor call and Method overriding
...
```javascript
/**
 * JavaScriptClassInheritance - JavaScript Class Inheritance
 * A practical implementation demonstrating javascript class inheritance
 */
class JavaScriptClassInheritance {
  constructor(options = {}) {
...
const project = new JavaScriptClassInheritance();
try {
  project.add("extends keyword");
  project.add("super() constructor call");
...
1. Implement the extends keyword functionality
2. Add super() constructor call capabilities
...
```
Processed: [
  { original: "extends keyword", processed: "EXTENDS KEYWORD", timestamp: ... },
  { original: "super() constructor call", processed: "SUPER() CONSTRUCTOR CALL", timestamp: ... }
]
History: [
  { action: "add", item: "extends keyword", timestamp: ... },
  { action: "add", item: "super() constructor call", timestamp: ... }
]
```
