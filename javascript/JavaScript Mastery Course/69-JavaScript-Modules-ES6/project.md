# JavaScript Modules (ES6) - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Modules (ES6).
...
1. Apply named exports in a practical context
2. Implement javascript modules (es6) following best practices
...
- Implement Named exports and Default exports and Named imports
...
```javascript
/**
 * JavaScriptModulesES6 - JavaScript Modules (ES6)
 * A practical implementation demonstrating javascript modules (es6)
 */
class JavaScriptModulesES6 {
  constructor(options = {}) {
...
const project = new JavaScriptModulesES6();
try {
  project.add("Named exports");
  project.add("Default exports");
...
1. Implement the named exports functionality
2. Add Default exports capabilities
...
```
Processed: [
  { original: "Named exports", processed: "NAMED EXPORTS", timestamp: ... },
  { original: "Default exports", processed: "DEFAULT EXPORTS", timestamp: ... }
]
History: [
  { action: "add", item: "Named exports", timestamp: ... },
  { action: "add", item: "Default exports", timestamp: ... }
]
```
