# JavaScript Data Visualization - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Data Visualization.
...
1. Apply chart.js for charts in a practical context
2. Implement javascript data visualization following best practices
...
- Implement Chart.js for charts and D3.js data joins and Canvas 2D API
...
```javascript
/**
 * JavaScriptDataVisualization - JavaScript Data Visualization
 * A practical implementation demonstrating javascript data visualization
 */
class JavaScriptDataVisualization {
  constructor(options = {}) {
...
const project = new JavaScriptDataVisualization();
try {
  project.add("Chart.js for charts");
  project.add("D3.js data joins");
...
1. Implement the chart.js for charts functionality
2. Add D3.js data joins capabilities
...
```
Processed: [
  { original: "Chart.js for charts", processed: "CHART.JS FOR CHARTS", timestamp: ... },
  { original: "D3.js data joins", processed: "D3.JS DATA JOINS", timestamp: ... }
]
History: [
  { action: "add", item: "Chart.js for charts", timestamp: ... },
  { action: "add", item: "D3.js data joins", timestamp: ... }
]
```
