# JavaScript Web Storage - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Web Storage.
...
1. Apply localstorage api in a practical context
2. Implement javascript web storage following best practices
...
- Implement localStorage API and sessionStorage API and Storage events
...
```javascript
/**
 * JavaScriptWebStorage - JavaScript Web Storage
 * A practical implementation demonstrating javascript web storage
 */
class JavaScriptWebStorage {
  constructor(options = {}) {
...
const project = new JavaScriptWebStorage();
try {
  project.add("localStorage API");
  project.add("sessionStorage API");
...
1. Implement the localstorage api functionality
2. Add sessionStorage API capabilities
...
```
Processed: [
  { original: "localStorage API", processed: "LOCALSTORAGE API", timestamp: ... },
  { original: "sessionStorage API", processed: "SESSIONSTORAGE API", timestamp: ... }
]
History: [
  { action: "add", item: "localStorage API", timestamp: ... },
  { action: "add", item: "sessionStorage API", timestamp: ... }
]
```
