# JavaScript Data Table - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Data Table.
...
1. Apply table rendering in a practical context
2. Implement javascript data table following best practices
...
- Implement Table rendering and Column sorting and Row filtering
...
```javascript
/**
 * JavaScriptDataTable - JavaScript Data Table
 * A practical implementation demonstrating javascript data table
 */
class JavaScriptDataTable {
  constructor(options = {}) {
...
const project = new JavaScriptDataTable();
try {
  project.add("Table rendering");
  project.add("Column sorting");
...
1. Implement the table rendering functionality
2. Add Column sorting capabilities
...
```
Processed: [
  { original: "Table rendering", processed: "TABLE RENDERING", timestamp: ... },
  { original: "Column sorting", processed: "COLUMN SORTING", timestamp: ... }
]
History: [
  { action: "add", item: "Table rendering", timestamp: ... },
  { action: "add", item: "Column sorting", timestamp: ... }
]
```
