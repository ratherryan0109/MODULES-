# JavaScript GraphQL Basics - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript GraphQL Basics.
...
1. Apply graphql vs rest in a practical context
2. Implement javascript graphql basics following best practices
...
- Implement GraphQL vs REST and Queries and fields and Mutations
...
```javascript
/**
 * JavaScriptGraphQLBasics - JavaScript GraphQL Basics
 * A practical implementation demonstrating javascript graphql basics
 */
class JavaScriptGraphQLBasics {
  constructor(options = {}) {
...
const project = new JavaScriptGraphQLBasics();
try {
  project.add("GraphQL vs REST");
  project.add("Queries and fields");
...
1. Implement the graphql vs rest functionality
2. Add Queries and fields capabilities
...
```
Processed: [
  { original: "GraphQL vs REST", processed: "GRAPHQL VS REST", timestamp: ... },
  { original: "Queries and fields", processed: "QUERIES AND FIELDS", timestamp: ... }
]
History: [
  { action: "add", item: "GraphQL vs REST", timestamp: ... },
  { action: "add", item: "Queries and fields", timestamp: ... }
]
```
