# JavaScript DOM Traversal - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript DOM Traversal.
...
1. Apply parentnode vs parentelement in a practical context
2. Implement javascript dom traversal following best practices
...
- Implement parentNode vs parentElement and childNodes vs children and firstChild vs firstElementChild
...
```javascript
/**
 * JavaScriptDOMTraversal - JavaScript DOM Traversal
 * A practical implementation demonstrating javascript dom traversal
 */
class JavaScriptDOMTraversal {
  constructor(options = {}) {
...
const project = new JavaScriptDOMTraversal();
try {
  project.add("parentNode vs parentElement");
  project.add("childNodes vs children");
...
1. Implement the parentnode vs parentelement functionality
2. Add childNodes vs children capabilities
...
```
Processed: [
  { original: "parentNode vs parentElement", processed: "PARENTNODE VS PARENTELEMENT", timestamp: ... },
  { original: "childNodes vs children", processed: "CHILDNODES VS CHILDREN", timestamp: ... }
]
History: [
  { action: "add", item: "parentNode vs parentElement", timestamp: ... },
  { action: "add", item: "childNodes vs children", timestamp: ... }
]
```
