# JavaScript BOM (Browser Object Model) - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript BOM (Browser Object Model).
...
1. Apply window object in a practical context
2. Implement javascript bom (browser object model) following best practices
...
- Implement window object and navigator object (userAgent, geolocation) and screen object
...
```javascript
/**
 * JavaScriptBOM - JavaScript BOM (Browser Object Model)
 * A practical implementation demonstrating javascript bom (browser object model)
 */
class JavaScriptBOM {
  constructor(options = {}) {
...
const project = new JavaScriptBOM();
try {
  project.add("window object");
  project.add("navigator object (userAgent, geolocation)");
...
1. Implement the window object functionality
2. Add navigator object (userAgent, geolocation) capabilities
...
```
Processed: [
  { original: "window object", processed: "WINDOW OBJECT", timestamp: ... },
  { original: "navigator object (userAgent, geolocation)", processed: "NAVIGATOR OBJECT (USERAGENT, GEOLOCATION)", timestamp: ... }
]
History: [
  { action: "add", item: "window object", timestamp: ... },
  { action: "add", item: "navigator object (userAgent, geolocation)", timestamp: ... }
]
```
