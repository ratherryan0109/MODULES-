# JavaScript Hoisting - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Hoisting.
...
1. Apply variable hoisting (var) in a practical context
2. Implement javascript hoisting following best practices
...
- Implement Variable hoisting (var) and Function declaration hoisting and Temporal Dead Zone (TDZ)
...
```javascript
/**
 * JavaScriptHoisting - JavaScript Hoisting
 * A practical implementation demonstrating javascript hoisting
 */
class JavaScriptHoisting {
  constructor(options = {}) {
...
const project = new JavaScriptHoisting();
try {
  project.add("Variable hoisting (var)");
  project.add("Function declaration hoisting");
...
1. Implement the variable hoisting (var) functionality
2. Add Function declaration hoisting capabilities
...
```
Processed: [
  { original: "Variable hoisting (var)", processed: "VARIABLE HOISTING (VAR)", timestamp: ... },
  { original: "Function declaration hoisting", processed: "FUNCTION DECLARATION HOISTING", timestamp: ... }
]
History: [
  { action: "add", item: "Variable hoisting (var)", timestamp: ... },
  { action: "add", item: "Function declaration hoisting", timestamp: ... }
]
```
