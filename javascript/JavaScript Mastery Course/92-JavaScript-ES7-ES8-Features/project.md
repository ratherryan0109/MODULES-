# JavaScript ES7/ES8 Features - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript ES7/ES8 Features.
...
1. Apply array.prototype.includes in a practical context
2. Implement javascript es7/es8 features following best practices
...
- Implement Array.prototype.includes and Exponentiation operator (**) and Async/await
...
```javascript
/**
 * JavaScriptES7ES8Features - JavaScript ES7/ES8 Features
 * A practical implementation demonstrating javascript es7/es8 features
 */
class JavaScriptES7ES8Features {
  constructor(options = {}) {
...
const project = new JavaScriptES7ES8Features();
try {
  project.add("Array.prototype.includes");
  project.add("Exponentiation operator (**)");
...
1. Implement the array.prototype.includes functionality
2. Add Exponentiation operator (**) capabilities
...
```
Processed: [
  { original: "Array.prototype.includes", processed: "ARRAY.PROTOTYPE.INCLUDES", timestamp: ... },
  { original: "Exponentiation operator (**)", processed: "EXPONENTIATION OPERATOR (**)", timestamp: ... }
]
History: [
  { action: "add", item: "Array.prototype.includes", timestamp: ... },
  { action: "add", item: "Exponentiation operator (**)", timestamp: ... }
]
```
