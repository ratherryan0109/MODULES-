# JavaScript Scope and Closures - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Scope and Closures.
...
1. Apply global scope in a practical context
2. Implement javascript scope and closures following best practices
...
- Implement Global scope and Function scope and Block scope (let/const)
...
```javascript
/**
 * JavaScriptScopeandClosures - JavaScript Scope and Closures
 * A practical implementation demonstrating javascript scope and closures
 */
class JavaScriptScopeandClosures {
  constructor(options = {}) {
...
const project = new JavaScriptScopeandClosures();
try {
  project.add("Global scope");
  project.add("Function scope");
...
1. Implement the global scope functionality
2. Add Function scope capabilities
...
```
Processed: [
  { original: "Global scope", processed: "GLOBAL SCOPE", timestamp: ... },
  { original: "Function scope", processed: "FUNCTION SCOPE", timestamp: ... }
]
History: [
  { action: "add", item: "Global scope", timestamp: ... },
  { action: "add", item: "Function scope", timestamp: ... }
]
```
