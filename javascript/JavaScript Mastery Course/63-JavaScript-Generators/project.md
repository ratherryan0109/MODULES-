# JavaScript Generators - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Generators.
...
1. Apply generator function syntax (function*) in a practical context
2. Implement javascript generators following best practices
...
- Implement Generator function syntax (function*) and yield keyword and Generator.next() method
...
```javascript
/**
 * JavaScriptGenerators - JavaScript Generators
 * A practical implementation demonstrating javascript generators
 */
...
const project = new JavaScriptGenerators();
try {
  project.add("Generator function syntax (function*)");
  project.add("yield keyword");
...
1. Implement the generator function syntax (function*) functionality
2. Add yield keyword capabilities
...
```
Processed: [
  { original: "Generator function syntax (function*)", processed: "GENERATOR FUNCTION SYNTAX (FUNCTION*)", timestamp: ... },
  { original: "yield keyword", processed: "YIELD KEYWORD", timestamp: ... }
]
History: [
  { action: "add", item: "Generator function syntax (function*)", timestamp: ... },
  { action: "add", item: "yield keyword", timestamp: ... }
]
```
