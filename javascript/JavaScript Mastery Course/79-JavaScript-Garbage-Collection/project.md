# JavaScript Garbage Collection - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Garbage Collection.
...
1. Apply reachability concept in a practical context
2. Implement javascript garbage collection following best practices
...
- Implement Reachability concept and Mark-and-sweep algorithm and Generational GC
...
```javascript
/**
 * JavaScriptGarbageCollection - JavaScript Garbage Collection
 * A practical implementation demonstrating javascript garbage collection
 */
class JavaScriptGarbageCollection {
  constructor(options = {}) {
...
const project = new JavaScriptGarbageCollection();
try {
  project.add("Reachability concept");
  project.add("Mark-and-sweep algorithm");
...
1. Implement the reachability concept functionality
2. Add Mark-and-sweep algorithm capabilities
...
```
Processed: [
  { original: "Reachability concept", processed: "REACHABILITY CONCEPT", timestamp: ... },
  { original: "Mark-and-sweep algorithm", processed: "MARK-AND-SWEEP ALGORITHM", timestamp: ... }
]
History: [
  { action: "add", item: "Reachability concept", timestamp: ... },
  { action: "add", item: "Mark-and-sweep algorithm", timestamp: ... }
]
```
