# JavaScript Numbers and Math - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Numbers and Math.
...
1. Apply number type and ieee 754 in a practical context
2. Implement javascript numbers and math following best practices
...
- Implement Number type and IEEE 754 and Integer vs floating point and Number methods (parseInt, parseFloat, toFixed)
...
```javascript
/**
 * JavaScriptNumbersandMath - JavaScript Numbers and Math
 * A practical implementation demonstrating javascript numbers and math
 */
class JavaScriptNumbersandMath {
  constructor(options = {}) {
...
const project = new JavaScriptNumbersandMath();
try {
  project.add("Number type and IEEE 754");
  project.add("Integer vs floating point");
...
1. Implement the number type and ieee 754 functionality
2. Add Integer vs floating point capabilities
...
```
Processed: [
  { original: "Number type and IEEE 754", processed: "NUMBER TYPE AND IEEE 754", timestamp: ... },
  { original: "Integer vs floating point", processed: "INTEGER VS FLOATING POINT", timestamp: ... }
]
History: [
  { action: "add", item: "Number type and IEEE 754", timestamp: ... },
  { action: "add", item: "Integer vs floating point", timestamp: ... }
]
```
