# JavaScript DOM Events - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript DOM Events.
...
1. Apply addeventlistener in a practical context
2. Implement javascript dom events following best practices
...
- Implement addEventListener and removeEventListener and Event object properties
...
```javascript
/**
 * JavaScriptDOMEvents - JavaScript DOM Events
 * A practical implementation demonstrating javascript dom events
 */
class JavaScriptDOMEvents {
  constructor(options = {}) {
...
const project = new JavaScriptDOMEvents();
try {
  project.add("addEventListener");
  project.add("removeEventListener");
...
1. Implement the addeventlistener functionality
2. Add removeEventListener capabilities
...
```
Processed: [
  { original: "addEventListener", processed: "ADDEVENTLISTENER", timestamp: ... },
  { original: "removeEventListener", processed: "REMOVEEVENTLISTENER", timestamp: ... }
]
History: [
  { action: "add", item: "addEventListener", timestamp: ... },
  { action: "add", item: "removeEventListener", timestamp: ... }
]
```
