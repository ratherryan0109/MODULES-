# JavaScript Image Editor - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Image Editor.
This project will help you apply the following concepts in a real-world scenario:

- Canvas image loading
- Image filters (brightness, contrast, sepia)
...
1. Apply canvas image loading in a practical context
2. Implement javascript image editor following best practices
...
- Implement Canvas image loading and Image filters (brightness, contrast, sepia) and Drawing tools (brush, eraser, shapes)
...
```javascript
/**
 * JavaScriptImageEditor - JavaScript Image Editor
 * A practical implementation demonstrating javascript image editor
 */
class JavaScriptImageEditor {
  constructor(options = {}) {
...
const project = new JavaScriptImageEditor();
try {
  project.add("Canvas image loading");
  project.add("Image filters (brightness, contrast, sepia)");
...
1. Implement the canvas image loading functionality
2. Add Image filters (brightness, contrast, sepia) capabilities
...
```
Processed: [
  { original: "Canvas image loading", processed: "CANVAS IMAGE LOADING", timestamp: ... },
  { original: "Image filters (brightness, contrast, sepia)", processed: "IMAGE FILTERS (BRIGHTNESS, CONTRAST, SEPIA)", timestamp: ... }
]
History: [
  { action: "add", item: "Canvas image loading", timestamp: ... },
  { action: "add", item: "Image filters (brightness, contrast, sepia)", timestamp: ... }
]
```
