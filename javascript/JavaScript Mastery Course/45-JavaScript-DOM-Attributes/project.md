# JavaScript DOM Attributes - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript DOM Attributes.
...
1. Apply getattribute/setattribute in a practical context
2. Implement javascript dom attributes following best practices
...
- Implement getAttribute/setAttribute and removeAttribute and hasAttribute
...
```javascript
/**
 * JavaScriptDOMAttributes - JavaScript DOM Attributes
 * A practical implementation demonstrating javascript dom attributes
 */
class JavaScriptDOMAttributes {
  constructor(options = {}) {
...
const project = new JavaScriptDOMAttributes();
try {
  project.add("getAttribute/setAttribute");
  project.add("removeAttribute");
...
1. Implement the getattribute/setattribute functionality
2. Add removeAttribute capabilities
...
```
Processed: [
  { original: "getAttribute/setAttribute", processed: "GETATTRIBUTE/SETATTRIBUTE", timestamp: ... },
  { original: "removeAttribute", processed: "REMOVEATTRIBUTE", timestamp: ... }
]
History: [
  { action: "add", item: "getAttribute/setAttribute", timestamp: ... },
  { action: "add", item: "removeAttribute", timestamp: ... }
]
```
