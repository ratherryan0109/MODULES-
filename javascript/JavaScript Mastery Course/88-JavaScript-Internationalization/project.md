# JavaScript Internationalization - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Internationalization.
...
1. Apply intl.datetimeformat in a practical context
2. Implement javascript internationalization following best practices
...
- Implement Intl.DateTimeFormat and Intl.NumberFormat and Intl.Collator for sorting
...
```javascript
/**
 * JavaScriptInternationalization - JavaScript Internationalization
 * A practical implementation demonstrating javascript internationalization
 */
class JavaScriptInternationalization {
  constructor(options = {}) {
...
const project = new JavaScriptInternationalization();
try {
  project.add("Intl.DateTimeFormat");
  project.add("Intl.NumberFormat");
...
1. Implement the intl.datetimeformat functionality
2. Add Intl.NumberFormat capabilities
...
```
Processed: [
  { original: "Intl.DateTimeFormat", processed: "INTL.DATETIMEFORMAT", timestamp: ... },
  { original: "Intl.NumberFormat", processed: "INTL.NUMBERFORMAT", timestamp: ... }
]
History: [
  { action: "add", item: "Intl.DateTimeFormat", timestamp: ... },
  { action: "add", item: "Intl.NumberFormat", timestamp: ... }
]
```
