# JavaScript Array Sorting - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Array Sorting.
...
1. Apply sort() method in a practical context
2. Implement javascript array sorting following best practices
...
- Implement sort() method and Custom compare functions and String sorting with localeCompare
...
```javascript
/**
 * JavaScriptArraySorting - JavaScript Array Sorting
 * A practical implementation demonstrating javascript array sorting
 */
class JavaScriptArraySorting {
  constructor(options = {}) {
...
const project = new JavaScriptArraySorting();
try {
  project.add("sort() method");
  project.add("Custom compare functions");
...
1. Implement the sort() method functionality
2. Add Custom compare functions capabilities
...
```
Processed: [
  { original: "sort() method", processed: "SORT() METHOD", timestamp: ... },
  { original: "Custom compare functions", processed: "CUSTOM COMPARE FUNCTIONS", timestamp: ... }
]
History: [
  { action: "add", item: "sort() method", timestamp: ... },
  { action: "add", item: "Custom compare functions", timestamp: ... }
]
```
