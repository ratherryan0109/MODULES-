# JavaScript Event Delegation - Mini Project

## Project Overview
Build a practical application that demonstrates your understanding of JavaScript Event Delegation.
...
1. Apply event bubbling mechanism in a practical context
2. Implement javascript event delegation following best practices
...
- Implement Event bubbling mechanism and Event capturing phase and Event delegation pattern
...
```javascript
/**
 * JavaScriptEventDelegation - JavaScript Event Delegation
 * A practical implementation demonstrating javascript event delegation
 */
class JavaScriptEventDelegation {
  constructor(options = {}) {
...
const project = new JavaScriptEventDelegation();
try {
  project.add("Event bubbling mechanism");
  project.add("Event capturing phase");
...
1. Implement the event bubbling mechanism functionality
2. Add Event capturing phase capabilities
...
```
Processed: [
  { original: "Event bubbling mechanism", processed: "EVENT BUBBLING MECHANISM", timestamp: ... },
  { original: "Event capturing phase", processed: "EVENT CAPTURING PHASE", timestamp: ... }
]
History: [
  { action: "add", item: "Event bubbling mechanism", timestamp: ... },
  { action: "add", item: "Event capturing phase", timestamp: ... }
]
```
